...
handoffs:
    ...
    - label: Check Touch Accessibility
      agent: accessibility
      prompt: Audit the responsive changes for touch target size, hover-only controls without focus-visible or pointer-coarse fallbacks, and focus order on small screens.
---
